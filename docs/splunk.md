...
~~~
| stats list(FieldName1), values(FieldName2) by FieldName3 FieldName4
~~~
Creates a table where events are grouped by FieldName3 and FieldName4 and list all of FieldName1 values available
